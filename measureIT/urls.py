...
urlpatterns = [
    ...
    path('lab/<str:id_number>/add_command', views.addCommand, name="addCommand"),
    ...
    path('lab/<str:id_number>/<str:name>', views.device, name="device"),path('lab/<str:id_number>/<str:name>/measure_result/<str:command>', views.measureResult, name="measure_result"),
    path('lab/<str:id_number>/list/measures', views.measures, name="measures"),
    path('lab/<str:id_number>/measure/<str:id>', views.measureDetail, name="measure_detail")
